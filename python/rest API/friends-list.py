...
for user in users:
    ...
    while next_cursor!=0:
        ...
        if next_cursor<0:
            timeline_endpoint = "https://api.twitter.com/1.1/friends/list.json?count=200&cursor=-1&screen_name="+user+"&skip_status=true&include_user_entities=true"

        else:
            timeline_endpoint = "https://api.twitter.com/1.1/friends/list.json?count=200&cursor="+str(next_cursor)+"&screen_name="+user+"&skip_status=true&include_user_entities=true";
